...
export function valida(input) {
  ...
  if(input.validity.valid) {
    ...
    input.parenteElement.classList.add('input-container--invalido')
  }
}
...
const mensagensDeErro = {
  ...
  senha:{
    ...
    patternMismatch: 'A senha deve conter: entre 6 a 12 caracteres, pelo menos uma letra maiúscula, um número e não símbolos'
  },
  dataNascimento:{
    valueMissing: 'O campo data de nascimento não pode estar vazio',
    customError: 'Você dever ser maoir que 18 anos para se cadastrar'
  }
